...
<head>
  ...
  <title>WebReceiptPro | Password Change</title>
...
?>
  ...
  <section class="section" style="padding: 1rem 1.5rem;">
      ...
      <div class="container" style="max-width:500px; padding:20px; background:#e6e4e4">
        ...
        <!-- main form -->
        <form method="POST" action="includes/password_change.php">
          <div class="field">
            ...
            <p class="help is-dark">Enter New Password</p>
          </div>
		<br><br>

          <div class="buttons is-centered"> 
          <button type="submit" class="button is-primary" value=" reset " onclick="return formhash(this.form, this.form.password);" >Reset</button>
          </div>
        </form>
      </div>
    </div>
