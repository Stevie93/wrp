...
$sql = "INSERT INTO data(shop, client, phone, item, amount, product, reference, outstanding, comment) VALUES ('$ourname', '$clientname', '$MOBILENUMBERS', '$item', '$amount', '$product', '$out2', '$outstanding', '$comment');";
